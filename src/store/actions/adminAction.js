...
import {
    ...
    deleteUserService, editUserService, getTopDoctorHomeService, getAllDoctors, saveDetailDoctor, getAllSpecialty, getAllClinic
    ...
    return async (dispatch, getState) => {
        try {
            ...
            if (resPrice && resPrice.errCode === 0
                ...
                dispatch(fetchRequireDoctorInforFailded());
            }
        } catch (e) {
            fetchRequireDoctorInforFailded();
        }
    }
...
export const fetchRequireDoctorInforFailded = () => ({
